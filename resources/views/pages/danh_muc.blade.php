...
<div class="container_fullwidth">
            <div class="container">
               <div class="hot-products">
                  <h3 class="title"><strong>Danh mục</strong> {{ $cate->name }}</h3>
                        ...
                        @foreach($products as $product)
                           <div class="col-md-3 col-sm-6">
                              <div class="products">
                                 ...
                                 <div class="thumbnail"><a href="{{route('detail',['id' => $product->id])}}"><img src="{{asset('images')}}/{{$product->img}}" style="height: 200px" alt="Product Name"></a></div>
